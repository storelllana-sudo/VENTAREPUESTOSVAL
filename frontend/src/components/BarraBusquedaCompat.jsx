...
export default function BarraBusquedaCompat({ busqueda, onChangeBusqueda, onSubmitBusqueda }) {
  return (
    <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
      <div>
        <h1 className="text-2xl font-bold text-[#f0f6fc]">
          Buscador de Compatibilidades de Repuestos
        </h1>
        <p className="text-sm text-[#8b949e] mt-1">
          Ecosistema ERP Repuestos VAL — Cruce de Vehículos, Motores y Modelos
        </p>
      </div>
      <form onSubmit={onSubmitBusqueda} className="flex gap-2 w-full md:w-96">
        <input
          ...
          placeholder="Ej: Toyota Yaris, Pastillas, 2015, 1.5..."
          value={busqueda}
